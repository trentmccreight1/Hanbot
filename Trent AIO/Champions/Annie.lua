...
if player.charName ~= "Annie" then
    print("not using annie not loading")
    return
end
local menu = menu("Trent_Annielelele", "Trent Annie")
...
local function KillSteal()
	...
	for i, enemies in ipairs(enemy) do
		if enemies and common.IsValidTarget(enemies) and not common.CheckBuffType(enemies, 18) then
